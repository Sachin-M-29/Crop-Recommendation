    ...
    <div className="min-h-screen bg-white text-gray-800 py-16 px-6 md:px-12">
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-lg leading-relaxed mb-4">
          Welcome to our <span className="font-semibold">Crop Recommendation Systems</span>! <p>We are building something awesome.</p> experts and technology enthusiasts dedicated to transforming farming with smart, data-driven tools.
        </p>
        <p className="text-lg leading-relaxed mb-4">
